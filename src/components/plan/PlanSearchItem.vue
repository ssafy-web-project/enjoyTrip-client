      ...
      <div class="info">
        <span style="display: table-cell; vertical-align: middle">
          <button
            ...
            <font-awesome-icon
              class="fontawesom"
              icon="fa-solid fa-location-dot fa-lg" /></button
          ><button
            v-else-if="spot.theme == 14"
            type="button"
            ...
            <font-awesome-icon
              class="fontawesom"
              icon="fa-solid fa-landmark fa-lg" /></button
          ><button
            v-else-if="spot.theme == 15"
            type="button"
            ...
            <font-awesome-icon
              class="fontawesom"
              icon="fa-solid fa-calendar fa-lg" /></button
          ><button
            v-else-if="spot.theme == 28"
            type="button"
